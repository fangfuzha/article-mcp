...
- 📄 **文献详情获取** - 获取全文内容，支持 Markdown/XML/Text 格式
- 📚 **参考文献获取** - 智能去重，多数据源合并
- 🔗 **文献关系分析** - 引用网络、相似文献发现
...
| `get_article_details`      | 获取文献全文（支持批量）   |
| `get_references`           | 获取参考文献列表           |
| `get_literature_relations` | 分析文献引用关系网络       |
...
| 变量                     | 说明                                 |
| ------------------------ | ------------------------------------ |
| `EASYSCHOLAR_SECRET_KEY` | EasyScholar API 密钥（期刊质量评估），[点击获取](https://www.easyscholar.cc/open/openKey) |
